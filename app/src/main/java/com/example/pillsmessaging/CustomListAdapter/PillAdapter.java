...
public class PillAdapter extends RecyclerView.Adapter<PillAdapter.ViewHolder> {
    ...
    public void updateData(List<ItemPill> data, boolean isAvailable) {
        List<ItemPill> resultArray = new ArrayList<>();
        if (isAvailable) {
            for (ItemPill item : data) {
                if (item.isAvailable()) {
                    resultArray.add(item);
                }
            }
        } else resultArray = data;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view, RecyclerViewAction recyclerViewInterface) {
            ...
            pillTextView.setOnClickListener(v -> {
                if (recyclerViewInterface != null) {
                    int position = getAdapterPosition();
